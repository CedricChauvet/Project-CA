...
def extration_sommaire():
    ...
    print("egal?", df["Titre"][1][0:-1] == blocks_2[0]["text"][0:-1])
    # compare le premier element de la page 2 avec les 2 premiers elements du pandas
    if df["Titre"][1][0:-1] == blocks_2[0]["text"][0:-1] or df["Titre"][0][0:-1] == blocks_2[0]["text"][0:-1]:
        print("le sommaire tient sur une page")
    else:
...
blocks, font_size = read_a_page(doc, 3)
